...
if dynahate:
    ...
    for round_id in [1, 2, 3, 4]: # , 2, 3, 4
        for t in dynahate_task_formats:
            BASE_DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "dynahate", f"{round_id}_{t}")
            dynahate_tsv_path = {
                "test": os.path.join(BASE_DATA_DIR, "test.tsv"),
                "train": os.path.join(BASE_DATA_DIR, "train.tsv"),
                "validation": os.path.join(BASE_DATA_DIR, "dev.tsv")
            ...
            BASE_DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "dynahate", "100-shot", f"{round_id}_{t}")
            dynahate_tsv_path = {
                "test": os.path.join(BASE_DATA_DIR, "test.tsv"),
                "train": os.path.join(BASE_DATA_DIR, "train.tsv"),
                "validation": os.path.join(BASE_DATA_DIR, "dev.tsv")
...
if ethics:
    ...
    for tf in ethics_task_formats:
        for task in tasks:
            ETHICS_DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "ethics", f"ethics_{tf}")
            ethics_tsv_path = {
            ...
            ETHICS_DATA_DIR = os.path.join(ETHICS_DATA_DIR, "100-shot")
            ethics_tsv_path = {
                "validation": os.path.join(ETHICS_DATA_DIR, f"{task}/test.tsv"),
                "test": os.path.join(ETHICS_DATA_DIR, f"{task}/test_hard.tsv"),
                "train": os.path.join(ETHICS_DATA_DIR, f"{task}/train.tsv"),
...
latenthatred = False
if latenthatred:
    DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "latenthatred", "latenthatred_st")
    tsv_path = {
        "validation": os.path.join(DATA_DIR, f"dev.tsv"),
        "test": os.path.join(DATA_DIR, f"test.tsv"),
        "train": os.path.join(DATA_DIR, f"train.tsv"),
    ...
    DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "latenthatred", "latenthatred_st", "100-shot")
    tsv_path = {
        "validation": os.path.join(DATA_DIR, f"dev.tsv"),
        "test": os.path.join(DATA_DIR, f"test.tsv"),
        "train": os.path.join(DATA_DIR, f"train.tsv"),
    ...
    DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "latenthatred", "latenthatred_yesno")
    tsv_path = {
        "validation": os.path.join(DATA_DIR, f"dev.tsv"),
        "test": os.path.join(DATA_DIR, f"test.tsv"),
        "train": os.path.join(DATA_DIR, f"train.tsv"),
    ...
    DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "latenthatred", "latenthatred_yesno", "100-shot")
    tsv_path = {
        "validation": os.path.join(DATA_DIR, f"dev.tsv"),
        "test": os.path.join(DATA_DIR, f"test.tsv"),
        "train": os.path.join(DATA_DIR, f"train.tsv"),
    ...
    DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "latenthatred", "latenthatred_yesno_class_only")
    tsv_path = {
        "validation": os.path.join(DATA_DIR, f"dev.tsv"),
        "test": os.path.join(DATA_DIR, f"test.tsv"),
        "train": os.path.join(DATA_DIR, f"train.tsv"),
    ...
    DATA_DIR = os.path.join(PROJECT_ROOT, "data", "v11_downstream", "latenthatred", "latenthatred_yesno_class_only", "100-shot")
    tsv_path = {
        "validation": os.path.join(DATA_DIR, f"dev.tsv"),
        "test": os.path.join(DATA_DIR, f"test.tsv"),
        "train": os.path.join(DATA_DIR, f"train.tsv"),
...
v11 = True
if v11:
    # 로컬 파일시스템에서 데이터 로드 (상대 경로 사용 - 더 오류 덜 일으키는 방식)
    CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))  # /content/delphi/src/delphi_plus/train
    PROJECT_ROOT = os.path.abspath(os.path.join(CURRENT_DIR, "../../.."))  # /content/delphi
    DATA_DIR = os.path.join(PROJECT_ROOT, "data/v11_declare_only/")
    tsv_path = {
...
if distribution:
    ...
    CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))  # /content/delphi/src/delphi_plus/train
    PROJECT_ROOT = os.path.abspath(os.path.join(CURRENT_DIR, "../../.."))  # /content/delphi
    DATA_DIR = os.path.join(PROJECT_ROOT, "data/v11_maj_vote/")
